...
class Level extends Entity
{
    ...
    {
        $this->table = config('wk-core.table.morph-rank.levels');
    ...
    public function lang()
    {
        if (
            ...
            return config('wk-core.class.morph-rank.levelLang');
        }
    }
    ...
    public function langs()
    {
        if (
            ...
            return $this->hasMany(config('wk-core.class.morph-rank.levelLang'), 'morph_id', 'id');
        }
    }
