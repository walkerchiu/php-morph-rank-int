...
use WalkerChiu\MorphRank\Models\Repositories\LevelRepository;

class LevelRepositoryTest extends \Orchestra\Testbench\TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->app->make(LevelRepository::class);
    }
    ...
    /**
     * A basic functional test on LevelRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\Repository
     *
     * @return void
     */
    public function testLevelRepository()
    {
        // Config
    ...
    /**
     * Unit test about Lang creation on LevelRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphRank\Models\Repositories\LevelRepository
     * 
     * @return void
     */
    public function testcreateLangWithoutCheck()
    {
        ...
        // Create Lang
            ...
            // Then
            $this->assertInstanceOf(LevelLang::class, $lang);
    }

    /**
     * Unit test about Enable and Disable on LevelRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphRank\Models\Repositories\LevelRepository
     *
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        factory(Level::class)->create(['is_enabled' => 0]);
        ...
        // Enable records
            // When
            $this->repository->whereToDisable(null, null, 'id', '>', 3);
            $count_enabled = $this->repository->ofEnabled(null, null)->count();
            $count_disabled = $this->repository->ofDisabled(null, null)->count();
            // Then
    ...
    /**
     * Unit test about Query List on LevelRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphRank\Models\Repositories\LevelRepository
     *
    ...
    /**
     * Unit test about FormTrait on LevelRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphRank\Models\Repositories\LevelRepository
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Level::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => Level::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            factory(Level::class)->create(['serial' => '123', 'identifier' => 'A123']);
            factory(Level::class)->create(['serial' => '124', 'identifier' => 'A124']);
            factory(Level::class)->create(['serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
    ...
    /**
     * Unit test about Auto Complete on LevelRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\MorphRank\Models\Repositories\LevelRepository
     *
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        factory(Level::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        factory(Level::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Level::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Level::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Level::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Level::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $this->repository->createLangWithoutCheck(['morph_id' => 1, 'morph_type' => Level::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $this->repository->createLangWithoutCheck(['morph_id' => 2, 'morph_type' => Level::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
